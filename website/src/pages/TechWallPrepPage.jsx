        ...
        <div className="container">
          ...
          <article className="article-content fade-in">
            ...
            <section className="article-section card">
              ...
              <ul>
                <li>Подготовка основания, при необходимости окрашивание поверхности;</li>
                <li>Выравнивание плоскости по маякам и устранение дефектов;</li>
                <li>Шпаклевание, шлифовка и обеспыливание;</li>
                <li>Нанесение специализированного грунтовочного состава для максимальной адгезии чернил.</li>
              </ul>
            </section>
          </article>
        </div>
