      ...
      <div className="container">
        ...
        <div className="b2b-header">
          ...
          <p className="b2b-subtitle">
            Для генеральных подрядчиков, девелоперов, отделочных компаний и управляющих организаций.
          </p>
        </div>
        ...
        <div className="b2b-grid">
          ...
          <div className="b2b-card">
            ...
            <p className="b2b-card-desc">
              Оперативный осмотр объекта, расчет сметы и подготовка пробных выкрасов.
            </p>
          </div>
          ...
          <div className="b2b-card">
            ...
            <p className="b2b-card-desc">
              Собственное оборудование, резервные мощности, большой опыт и компетенции.
            </p>
          </div>
          ...
          <div className="b2b-card">
            ...
            <p className="b2b-card-desc">
              Фиксация клиента за партнером, ведение проекта под ключ и индивидуальный подход.
            </p>
          </div>
        </div>
      </div>
